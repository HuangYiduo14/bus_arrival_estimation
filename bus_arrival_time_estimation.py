...
sql_select2 = """
select trans_time, trans_date, start_station, end_station
from ic_record
where bus_id = 22055
"""
...
bus_22055['trans_time'] = (bus_22055['trans_date']-20180601)*24*3600+bus_22055['trans_time']//10000*3600 + (bus_22055['trans_time']%10000)//100*60 + bus_22055['trans_time']%100
#plt.scatter(bus_22055['start_time'],bus_22055['start_station'],label='boarding',alpha=0.1)
plt.scatter(bus_22055['trans_time'],bus_22055['end_station'],alpha=0.1, label = 'alighting')
